...
const Errors = require("../api/errors/steelcoilsslitting-main-error.js");
...
const logger = LoggerFactory.get("SteelcoilsslittingMainAbl");

class SteelcoilsslittingMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["steelcoilsslittingMain"];
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuSteelcoilsslitting",
        typeCode: "uu-steelcoilsslitting-maing01",
        location: location,
...
module.exports = new SteelcoilsslittingMainAbl();
